...
class LYYDialog {
  ...
  LYYDialog build([BuildContext ctx]) {
  ...
  LYYDialog listViewOfRadioButton({
  ...
  LYYDialog divider({color, height}) {
    return this.widget(
      Divider(
