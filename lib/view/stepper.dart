...
///  * [Step]
///  * <https://material.io/archive/guidelines/components/steppers.html>
class LYYStepper extends StatefulWidget {
...
class _StepperState extends State<LYYStepper> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(LYYStepper oldWidget) {
  ...
  Widget _buildVertical() {
    return ListView(
      ...
      children: getRows(widget.steps),
    );
  }

  List<Widget> getRows(List<LYYStep> steps) {
    if (steps.isEmpty) {
      return List();
    } else {
      return steps.asMap().keys.map((i) {
        return Column(
          key: _keys[i],
          children: <Widget>[
            InkWell(
